...
export default function SignUpScreen({ navigation }: any) {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Success!",
        `Welcome to NEXUS, ${firstName}! Your admin account has been created.`,
        [
          {
            text: "Continue",
            onPress: () => navigation.replace('CSVUpload')
          }
        ]
      );
    } catch (error: any) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.form}>
        ...
        <TouchableOpacity
          style={[styles.neuButton, loading && styles.buttonDisabled]}
        ...
        {loading && <ActivityIndicator size="small" color="#1C1C1E" style={{ marginTop: 10 }} />}
